...
\stochastic{CPursuit}                  & \stochastic{\textbf{90.6}} & \stochastic{9.4}  & \stochastic{2.1}  & \stochastic{High} \\
...
\hline
\neural{CPursuitNeuralUCB (Default)}   & \neural{89.2}     & \neural{91.7}     & \neural{91.3} \\
\performance{CPursuit}                 & \performance{89.2} & \performance{90.2} & \performance{90.3} \\
\neural{GNeuralUCB (Default)}          & \neural{87.7}     & \neural{91.0}     & \neural{91.5} \\
\performance{CEpsilonGreedy}           & \performance{87.7} & \performance{88.0} & \performance{87.6} \\
CThompsonSampling                      & 67.1              & 67.0              & 67.5 \\
CEXP4                                  & 70.0              & 70.0              & 70.0 \\
CEpochGreedy                           & 37.6              & 37.6              & 37.7 \\
\legacy{EXPNeuralUCB (Default)}        & \legacy{85.7}     & \legacy{89.5}     & \legacy{88.2} \\
\hline
\end{tabular}
\end{table}
...
\hline
\neural{CPursuitNeuralUCB (Default)}   & \neural{91.7}     & \neural{91.8}     & \neural{+0.1} \\
\legacy{EXPNeuralUCB (Default)}        & \legacy{90.9}     & \legacy{91.4}     & \legacy{+0.5} \\
\neural{GNeuralUCB (Default)}          & \neural{90.8}     & \neural{91.75}    & \neural{+0.9} \\
...
\legacy{EXPNeuralUCB (Default)}       & \legacy{87.9}     & \legacy{88.2}     & \legacy{0.3} \\
\hline
\end{tabular}
\end{table}
